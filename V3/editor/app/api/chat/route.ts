...
export async function POST(req: NextRequest) {
    try {
        ...
        if (!response.ok) {
            ...
            let parsed: { message?: string; error?: { message?: string }; detail?: string } | null = null
            try {
        ...
        let data: { choices?: Array<{ message?: { content?: string }; text?: string }>; model?: string; usage?: unknown }
        try {
